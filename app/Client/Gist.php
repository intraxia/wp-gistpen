...
class Gist
{
    ...
    {
        if (!$this->ready && $token = (string) cmb2_get_option(\Gistpen::$plugin_name, '_wpgp_gist_token')) {
            $this->setToken($token);
        }
    ...
    public function isTokenValid()
    {
        ...
        try {
            set_transient('_wpgp_github_token_user_info', $this->client->api('me')->show());
    ...
    public function get($id)
    {
        ...
        try {
            $response = $this->client->api('gists')->show($id);
     ...
     * @return WP_Error
     */
    protected function setErrorNotReady()
    {
